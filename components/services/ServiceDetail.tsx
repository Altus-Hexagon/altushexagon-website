  ...
  return (
    ...
    >
      ...
      <div className={`${reversed ? "lg:order-2" : "lg:order-1"}`}>
        <div className="relative w-full max-w-sm mx-auto aspect-square rounded-2xl bg-surface border border-white/5 flex items-center justify-center overflow-hidden">
